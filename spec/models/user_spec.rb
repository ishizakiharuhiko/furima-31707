...
describe User do
  ...
  describe 'ユーザー新規登録' do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it 'emailが既に登録されている場合、登録できない' do
        @user.save
      ...
      it 'kana_first_nameは全角カナでなければ登録できない' do
        @user.kana_first_name = '陽彦'
        @user.valid?
      ...
      it 'kana_last__nameは全角カナでなければ登録できない' do
        @user.kana_last_name = '石崎'
        @user.valid?
